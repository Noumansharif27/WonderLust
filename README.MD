...
If a user was accessing a route which has a condition/restriction on that the user should be login first, i that case we have to remember the exact same route so make it convinent.
